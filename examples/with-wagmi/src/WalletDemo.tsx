    ...
    <div>
      ...
      <div className="status">
        ...
        <ol style={{ textAlign: 'left', maxWidth: '600px', margin: '0 auto' }}>
          ...
          <li>The connector uses the Phantom SDK's <code>sdk.ethereum</code> provider</li>
          <li>wagmi treats it as a standard Ethereum wallet</li>
          <li><code>useSignMessage</code> calls our provider's <code>signPersonalMessage</code></li>
