        ...
        resolve({
          ...
          swap: (options) => {
            window.phantom.app.swap({
              buy: `${options.buyTokenNetworkId}/address:${options.buyTokenAddress}`,
              sell: `${options.sellTokenNetworkId}/address:${options.sellTokenAddress}`,
              amount: options.sellAmount
            })
          },
          buy: (options) => {
            window.phantom.app.buy({
              tokenNetworkId: options.tokenNetworkId,
