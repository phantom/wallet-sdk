...
import { AbstractWalletStandard } from "./AbstractWalletStandard";
...
export class PhantomSDKWalletStandard extends AbstractWalletStandard implements Wallet {
  ...
  readonly #connect: StandardConnectMethod = async () => {
    try {
      // Try to auto-connect first (existing session)
      ...
      // Account-connect failed, connect normally
    }
